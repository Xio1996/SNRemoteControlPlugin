...
#define OUR_REGISTRY_BASE HKEY_CURRENT_USER
#define OUR_REGISTRY_AREA "Software\\Simulation Curriculum Corp.\\Starry Night Focuser Plugin"
...
short ConfigFocuser(void)
{
	...
	__try
	{
		...
		static LPOLESTR name2 = L"DeviceType";
